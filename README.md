...
Після `/start` новий користувач отримає опис курсу, реквізити та прохання надіслати скріншот квитанції. Коли користувач надсилає фото, бот відправляє його в групу `MANUAL_PAYMENT_REVIEW_CHAT_ID` з кнопками `Підтвердити` і `Відхилити`.
